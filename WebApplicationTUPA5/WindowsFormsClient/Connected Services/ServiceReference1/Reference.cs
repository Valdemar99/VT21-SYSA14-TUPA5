...
namespace WindowsFormsClient.ServiceReference1 {
    ...
    public partial class AddEmployeeRequestBody {
        ...
        public AddEmployeeRequestBody(string no_, string first_Name, string last_Name, string job_Title, string address, string phone_No_, string e_Mail) {
            this.no_ = no_;
    ...
    public partial class UpdateEmployeeRequestBody {
        ...
        public UpdateEmployeeRequestBody(string no_, string first_Name, string last_Name, string job_Title, string address, string phone_No_, string e_Mail) {
            this.no_ = no_;
            this.first_Name = first_Name;
            this.last_Name = last_Name;
            this.job_Title = job_Title;
    ...
    public partial class WebServiceTUPA5SoapClient : System.ServiceModel.ClientBase<WindowsFormsClient.ServiceReference1.WebServiceTUPA5Soap>, WindowsFormsClient.ServiceReference1.WebServiceTUPA5Soap {
        ...
        public WebServiceTUPA5SoapClient(string endpointConfigurationName) : 
                base(endpointConfigurationName) {
        }
        
        public WebServiceTUPA5SoapClient(string endpointConfigurationName, string remoteAddress) : 
                base(endpointConfigurationName, remoteAddress) {
        }
        
        public WebServiceTUPA5SoapClient(string endpointConfigurationName, System.ServiceModel.EndpointAddress remoteAddress) : 
                base(endpointConfigurationName, remoteAddress) {
        }
        
        public WebServiceTUPA5SoapClient(System.ServiceModel.Channels.Binding binding, System.ServiceModel.EndpointAddress remoteAddress) : 
